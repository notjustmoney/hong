            ...
            <>
              ...
              <PostContainer>
                ...
                {activeItem === "1" && (
                  <Notice>
                    <Icon name="hashtag" />
                    포스팅된 내 게시글은 현재 홍대병 페이지에 노출되고 있는
                    글이며 모든 사용자가 접근할 수 있습니다.
                  </Notice>
                )}
                {activeItem === "2" && (
                  <Notice>
                    <Icon name="hashtag" />
                    업로드된 내 게시글은 현재 포스팅 전 단계의 글이며
                    회원님께서만 접근이 가능하고 직접 포스팅 할 수 있습니다.
                  </Notice>
                )}
                {activeItem === "3" && (
                  <Notice>
                    <Icon name="hashtag" />
                    회원님께서 좋아요를 누른 게시글들 입니다.
                  </Notice>
                )}
                {activeItem === "4" && (
                  <Notice>
                    <Icon name="hashtag" />
                    회원님께서 댓글을 단 게시글들 입니다.
                  </Notice>
                )}
                <MyPostsContainer>
                  {viewpost === null ||
                  (viewpost != null &&
                    typeof viewpost == "object" &&
                    !Object.keys(viewpost).length) ? (
                    <Nopost>
                      해당하는 글이 없습니다.
                      {activeItem === "1" && (
                        <div>
                          <p>혹시 판매자가 아니신가요?</p>
                          <p>
                            궁금하신점은 <AboutLink to="/about">여기</AboutLink>
                            를 참고해주세요.
                          </p>
                        </div>
                      )}
